...
async function importOperations() {
    ...
    for (const row of data) {
        ...
        // Assuming columns in Excel match or are similar to DB columns:
        // service, service_complement, mco, nature, libelle, chapitre_fonction, montant_prevu, termine, solde, commentaire
