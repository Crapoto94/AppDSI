          ...
          <div className="modal-content" style={{ width: '95vw', height: '90vh', maxWidth: '1200px' }}>
            ...
            <div style={{ flex: 1, background: '#f1f5f9', position: 'relative' }}>
              {activeDoc.doc_type === 'pdf' && (
                <iframe 
                  src={activeDoc.url.startsWith('http') ? activeDoc.url : (activeDoc.url.startsWith('/uploads') || activeDoc.url.startsWith('/api/storage') ? activeDoc.url : (activeDoc.url.startsWith('/storage') ? '/api' + activeDoc.url : `/api/magapp/docs/file/${activeDoc.url}`))} 
