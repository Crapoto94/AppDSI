...
const Admin: React.FC<AdminProps> = ({ section = 'main' }) => {
  ...
  const handleUpdateUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`Erreur lors de la mise Ã  jour : ${error?.response?.data?.message || error?.message || 'Erreur inconnue'}`);
    }
  };
