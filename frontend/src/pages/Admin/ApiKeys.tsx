...
const MODULES: { value: string; label: string }[] = [
  ...
  { value: 'finance', label: 'Finance (budget, tiers, contacts)' },
  { value: 'rh', label: 'RH / Organigramme' },
  { value: 'rencontres', label: 'Rencontres budgétaires' },
  { value: 'glpi', label: 'GLPI' },
  { value: 'documents', label: 'Documents / GED' },
  { value: 'calendrier', label: 'Calendrier DSI' },
  { value: 'live', label: 'Live / Permanences' },
  { value: 'mail', label: 'Mail Collector' },
  { value: 'transcript', label: 'Transcriptions' },
  { value: 'dashboard', label: 'Dashboard DSI' },
  { value: 'dxf', label: 'Plans / DXF' },
