...
export interface StockLevel {
  id: number; item_id?: number | null; parc_itemtype?: string; parc_glpi_id?: number;
  store_id: number; location_id?: number | null; stock_type: string;
  quantity: number; min_threshold: number;
  label: string; category?: string; brand?: string; model?: string; unit?: string;
  tracking_mode?: string; location_name?: string; serial_number?: string;
}
export interface Movement {
  id: number; item_id?: number | null; parc_itemtype?: string; parc_glpi_id?: number;
  store_id: number; location_id?: number | null; type: string; stock_type: string;
...
export const stocksApi = {
  ...
  // Catalogue — équipements du parc éligibles au stock
  listParcItems: (params?: { search?: string }) => get<ParcItem[]>('/api/stocks/parc-items', params),
...
export interface Delivery {
  ...
  lines?: { id: number; parc_itemtype?: string; parc_glpi_id?: number; item_id?: number; item_label?: string; item_reference?: string; quantity: number; serial_number?: string }[];
}
...
export interface ReceptionLine {
  id: number; reception_id: number; parc_itemtype?: string; parc_glpi_id?: number; item_id?: number | null; reference?: string;
...
export interface SerialItem {
  id: number; parc_itemtype?: string; parc_glpi_id?: number; item_id?: number | null; store_id: number; serial_number?: string | null; status: string;
