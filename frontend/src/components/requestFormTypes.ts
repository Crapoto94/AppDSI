...
// username : sAMAccountName AD (issu de la recherche AD, cf. ADUser côté
// useADSearch) — porté ici uniquement pour résoudre côté serveur la
// Direction/Service dans le référentiel RH quand
