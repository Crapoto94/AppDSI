...
import {
  ...
  Monitor, Database, Shield, ChevronRight, Bell, Lock, Sliders, Lightbulb, DollarSign, Wrench, Zap, Inbox, Network
} from 'lucide-react';
...
const AdminLayout: React.FC = () => {
  ...
  const menuItems = [
    ...
    { title: "Journal maintenance", icon: Wrench, path: "/admin/magapp" },
