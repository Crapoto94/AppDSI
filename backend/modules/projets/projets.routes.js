...
router.get('/journal-global', authenticateJWT, ctrl.getJournalGlobal);
...
router.put('/admin/types-documentaires', authenticateAdminOrPMO, ctrl.updateTypesDocumentaires);
