...
router.get('/snmp-collect-progress',                                      authenticateJWT, copieursController.getSnmpCollectProgress);
router.post('/snmp-collect-raw-canon',                                    authenticateJWT, copieursController.collectCanonRaw);
